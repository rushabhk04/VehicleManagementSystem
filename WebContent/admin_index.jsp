...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="resources_application/css/style.css">
...
public class mail{
	public  void admin_mail(){
		try{
	        ...
	        mailMessage.setSubject("Due dates!");
	        ...
	        email.append("</hrad>");
	        email.append("<body>");
	        email.append("Due dates of some vehicle transactions are within 15 days.<br>You can check due dates using link given below");
	        
	        email.append("<br>");
	        email.append("<br>");
	        email.append("<form action=\"http://localhost:8080/vehicle_management/due.jsp\" method=\"post\">");
...
String q6="select *from vehicle_transaction where CURDATE()+15 > insurance_upto or curdate()+15 > servicing_upto or curdate()+15 > pollution_control_valid or curdate()+15 > certificate_of_fitness ";
                        ...
                        <div class="col-xl-7 col-lg-7">
                            <div class="main-menu  d-none d-lg-block">
                                    ...
                                    <ul id="navigation">
                                       ...
                                       <li><a href="local_vehicle.jsp" style="font-size: 20px">Local Vehicle</a></li>
