...
<h2 style="text-align: center;"> RECENT APPLICATIONS </h2>
...
try {
	...
	String q="select *from application where datediff(curdate(),start_date)<=30 order by start_date desc";
...
<%while(results.next()) {%>
	...
	<% if(results.getInt("alloted")==1){ %>
	<%
	//System.out.println("okkkkkkk"+results.getString("app_no"));
	...
	st.setString(1, results.getString("emp_code"));
