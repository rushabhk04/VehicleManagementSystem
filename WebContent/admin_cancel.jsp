...
<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="admin_cancel">
				...
				<div class="wrap-input100 validate-input bg1">
					...
					<span class="label-input100">Cancellation Remark</span>
					<textarea class="input100" name="cancel_remarks" placeholder="Your remarks here...">
					</textarea>
				</div>
