...
<br><br><br><br><br><br><br>
	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact100-form validate-form" method="post" action="newfuel_trans">
 ...
 %>
  ...
  <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Please enter purpose of visit">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					...
					<input class="input100" type="text"  name="bill_no" placeholder="Enter Bill No"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Fill Date</span>
					<input class="input100" type="date"  name="filling_date" placeholder="Enter Bill No"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Name of Party</span>
					<input class="input100" type="text"  name="name_of_party" placeholder="Enter Name Of Party"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
				...
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					...
					<input class="input100" type="number" step="0.01" name="liter" placeholder="Enter fuel liters"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Cost</span>
					<input class="input100" type="number" step="0.01" name="cost" placeholder="Enter cost"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Average</span>
					<input class="input100" type="number" step="0.01" name="average" placeholder="Enter Average"  required>
				</div>
				<div class="wrap-input100 validate-input bg1 rs1-wrap-input100">
					<span class="label-input100">Cost per Km</span>
					<input class="input100" type="number" step="0.01" name="cost_per_km" placeholder="Enter cost per km"  required>
				</div>
